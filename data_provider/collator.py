...
def collator_text(batchs, max_node=512, multi_hop_max_dist=20, spatial_pos_max=20):
    data_aug1, data_aug2, text1, mask1, text2, mask2 = batchs[0], batchs[1], batchs[2], batchs[3], batchs[4], batchs[5]

    return (
        collator(data_aug1, max_node, multi_hop_max_dist, spatial_pos_max),
        collator(data_aug2, max_node, multi_hop_max_dist, spatial_pos_max),
        default_collate(text1),
        default_collate(mask1),
        default_collate(text2),
        default_collate(mask2)
    )